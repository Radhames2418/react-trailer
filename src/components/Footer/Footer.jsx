      ...
      <div className="container p-5 lg:p-0 mx-auto h-full flex lg:flex-row flex-col items-center gap-8 lg:gap-10">
        ...
        <div className="text-primary-700 text-justify">
          <p className="line-clamp-2 md:line-clamp-3 lg:line-clamp-none">
            ¡Descubre el emocionante mundo del cine con nuestra aplicación de
            trailers de películas! Entra en un universo lleno de emociones,
            drama, acción y risas. Nuestra plataforma te ofrece acceso a una
            amplia selección de avances cinematográficos, desde los éxitos de
            taquilla más recientes hasta los clásicos atemporales.
          </p>
        </div>

        <nav className="flex  gap-4">
          <ButtonRedSocial enlace={"https://facebook.com/"}>
            <svg
          ...
          <ButtonRedSocial enlace={"https://twitter.com/"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
              fill="currentColor"
          ...
          <ButtonRedSocial enlace={"https://youtube.com/"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
              fill="currentColor"
          ...
          <ButtonRedSocial enlace={"https://instagram.com/"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
              fill="currentColor"
          ...
          <ButtonRedSocial enlace={"https://tiktok.com/"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
              className="h-5 w-5"
          ...
          <ButtonRedSocial enlace={"https://github.com/"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
              fill="currentColor"
